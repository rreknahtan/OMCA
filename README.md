...
**newfixblob** - Script to fix blbobs with missing derivatives. Supply csv with image filenmae, media handling csid, damaged blob csid, uri / url to source image for upload
